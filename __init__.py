...
class Furbyface(OVOSSkill):
	...
	def on_settings_changed(self):
		...
		GPIO.setup(int(self.settings.get('timer_input_pin',12)), GPIO.IN,pull_up_down=GPIO.PUD_UP)
		...
		GPIO.add_event_detect(int(self.settings.get('back_input_pin',18)),GPIO.FALLING, callback=self.backbutton)
